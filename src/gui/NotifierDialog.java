...
public class NotifierDialog {
    ...
    private static Color       _titleFgColor = SWTResourceManager.getColor(40, 73, 97);//ColorCache.getColor(40, 73, 97);
    // text foreground color
    private static Color       _fgColor      = _titleFgColor;

    // shell gradient background color - top
    private static Color       _bgFgGradient = SWTResourceManager.getColor(226, 239, 249);//ColorCache.getColor(226, 239, 249);
    // shell gradient background color - bottom    
    private static Color       _bgBgGradient = SWTResourceManager.getColor(177, 211, 243);
    // shell border color
    private static Color       _borderColor  = _titleFgColor;
